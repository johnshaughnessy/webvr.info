...
/*      that._playAudioAlert();
  ...
  */
  ...
  this.queuePlay = function(timeoutInSec) {
    console.log("Setting timer " + timeoutInSec + " sec to play");
    var that = this;
    setTimeout(function(){ console.log("FINALLY PLAYING!"); that.elVideo.play(); }, timeoutInSec*1000);
  }
